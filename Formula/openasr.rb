...
class Openasr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "8435f5333dac683fb3a7bc478984af4e8ea54ef58afdb12ed1d4e7a6d83423a1"
    else
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "03417328e3c008f4aaf561213775679e3057619c5f9e1e9209d2bc60711981fb"
    else
      url "https://github.com/QuintinShaw/openasr/releases/download/v#{version}/openasr-#{version}-linux-x86_64.tar.gz"
      sha256 "79aac9e0b1e29d6bf4fc144321c36ac9ecf7bcb4a182fd5ff593705094696083"
    end
  end
